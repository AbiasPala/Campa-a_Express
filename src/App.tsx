  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7] font-sans text-[#111111] flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-[#111111] text-white flex flex-col justify-between hidden md:flex h-screen sticky top-0">
        <div className="p-8">
          {/* Logo con margen de seguridad (pl-4) y sin isotipo */}
          <div className="flex items-center mb-12 pl-4">
            <img src="/LP_H_B.png" alt="La Proa Logo" className="h-8 object-contain" />
          </div>
          ...
          <nav className="space-y-2">
            ...
            {/* Botón Activar Ahora reubicado en la barra lateral */}
            <div className="pt-4 mt-4 border-t border-white/10">
              <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 font-bold bg-[#9D00FF] text-white shadow-lg shadow-purple-900/50 hover:bg-purple-600">
                <Rocket size={20} />
                Activar Ahora
              </button>
            </div>
      ...
      <div className="md:hidden bg-[#111111] text-white p-4 flex items-center justify-between sticky top-0 z-50">
        {/* Logo con margen de seguridad (pl-2) y sin isotipo */}
        <div className="flex items-center pl-2">
          <img src="/LP_H_B.png" alt="La Proa Logo" className="h-6 object-contain" />
        </div>
        <div className="flex gap-2 items-center">
          {navItems.map((item) => {
            ...
            return (
              <button
                key={item.id}
                onClick={() => setActiveTab(item.id)}
                className={`p-2 rounded-lg ${activeTab === item.id ? 'bg-[#9D00FF] text-white' : 'bg-white/10 text-gray-400'}`}
              >
                <Icon size={18} />
              </button>
            );
          ...
          {/* Separador y Botón Activar Ahora en Móvil */}
          <div className="w-px h-6 bg-white/20 mx-1"></div>
          <button className="p-2 rounded-lg bg-[#9D00FF] text-white shadow-lg shadow-purple-900/50 hover:bg-purple-600 transition-colors">
            <Rocket size={18} />
          </button>
        </div>
      </div>
      ...
      <main className="flex-1 p-4 md:p-8 lg:p-10 overflow-y-auto">
        ...
        <div className="transition-all duration-500">
          ...
          {activeTab === 'strategy' && <StrategyTab setSelectedImage={setSelectedImage} />}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="md:col-span-2 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-center relative overflow-hidden">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-none tracking-tight mb-4 text-[#111]">
          ADELANTE,<br/>SIEMPRE<br/>ADELANTE <span className="text-[#9D00FF] font-light ml-2">↗</span>
        </h1>
        <p className="text-gray-500 max-w-md text-lg">
          En momentos de crisis las marcas no pueden frenar. Tienen que salir a buscar el mercado.
        </p>
      </div>
      ...
      <div className="bg-[#111111] text-white rounded-3xl p-8 border border-gray-800 shadow-xl flex flex-col justify-center items-center text-center relative overflow-hidden group hover:scale-[1.02] transition-transform">
        ...
        <h2 className="text-7xl font-bold mb-2">24<span className="text-3xl text-[#9D00FF]">H</span></h2>
        <div className="w-12 h-1 bg-[#9D00FF] rounded-full mb-4"></div>
        <p className="text-gray-400 font-medium">Tu campaña de alto impacto lista para salir al mercado.</p>
      </div>
      ...
      <div className="md:col-span-3 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          <p className="text-xs font-bold text-[#9D00FF] uppercase tracking-widest mb-2">Nuestra Estrategia</p>
          <h3 className="text-3xl font-extrabold mb-4 tracking-tight">CALLE + RADIO + ADS</h3>
          <p className="text-gray-600 mb-6 leading-relaxed">
            Desde La Proa desarrollamos campañas rápidas que combinan impacto masivo para <strong>generar leads y ventas</strong>. Tres medios trabajando coordinados para dominar tu sector.
          </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
            ...
            <p className="text-sm text-gray-500 font-medium mb-1">Impacto Estimado</p>
            <p className="text-2xl font-bold text-[#111]">+1.2M</p>
          </div>
          <div className="bg-purple-50 rounded-2xl p-5 border border-purple-100">
            <Megaphone size={24} className="text-[#9D00FF] mb-3" />
            <p className="text-sm text-purple-700 font-medium mb-1">Spots Radiales</p>
          ...
          <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100 col-span-2 flex justify-between items-center">
             <div>
               <p className="text-sm text-gray-500 font-medium mb-1">Velocidad de Retorno (ROI)</p>
...
function StrategyTab({ setSelectedImage }) {
  return (
    <div className="space-y-8">
      ...
      <div>
        <div className="mb-6">
          <span className="text-xs font-bold text-[#9D00FF] uppercase tracking-widest mb-1 block">El Por Qué</span>
          <h2 className="text-2xl font-extrabold tracking-tight">FACTORES CLAVE DEL ÉXITO</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:-translate-y-1 transition-transform">
            ...
            <h3 className="text-xl font-bold mb-3 tracking-tight">BAJO COSTO</h3>
            <p className="text-gray-600 leading-relaxed">Inversión optimizada inteligentemente para maximizar el retorno de cada centavo en el menor tiempo posible.</p>
          </div>
          {/* Card 2 */}
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:-translate-y-1 transition-transform">
            ...
            <h3 className="text-xl font-bold mb-3 tracking-tight">ALTÍSIMO IMPACTO</h3>
            <p className="text-gray-600 leading-relaxed">Presencia destacada en puntos neurálgicos que asegura que la marca no pase desapercibida bajo ninguna circunstancia.</p>
          </div>
          {/* Card 3 */}
          <div className="bg-gradient-to-br from-[#9D00FF] to-purple-800 text-white rounded-3xl p-8 shadow-md hover:-translate-y-1 transition-transform relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold mb-3 tracking-tight">RESULTADOS INMEDIATOS</h3>
            <p className="text-purple-100 leading-relaxed">Estrategia táctica orientada puramente a la conversión rápida y la generación de oportunidades.</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="mb-6 mt-12">
          <span className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1 block">El Ecosistema</span>
          <h2 className="text-2xl font-extrabold tracking-tight">LA FÓRMULA GANADORA</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FormulaCard 
            imgUrl="/Piramide calle.png"
            tag="Presencia"
            title="CALLE"
            desc="Cartelería en puntos estratégicos de alto tránsito de la ciudad para posicionamiento mental."
            onClick={() => setSelectedImage("/Piramide calle.png")}
          />
          <FormulaCard 
            imgUrl="/La piramide radio.png"
            tag="Alcance"
            title="RADIO"
  ...
  return (
    <div className="bg-white rounded-3xl p-4 border border-gray-100 shadow-sm group cursor-pointer" onClick={onClick}>
      ...
      <div className="px-2 pb-2">
        <p className="text-xs font-bold text-[#9D00FF] uppercase tracking-widest mb-2">{tag}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white p-6 rounded-3xl border border-gray-100 flex items-center gap-6 shadow-sm">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#9D00FF] mb-2 tracking-tight">CAMPAÑA CREATIVA</h3>
              <p className="text-gray-600">Concepto, mensaje y diseño que ordena y da sentido a toda la comunicación de la marca. Directo al punto.</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 flex items-center gap-6 shadow-sm">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#111] mb-2 tracking-tight">PRESUPUESTO DE MEDIOS</h3>
              <p className="text-gray-600">Planificación precisa: Cartelería en zonas clave + radios segmentadas + ads configurados para captar demanda.</p>
            </div>
          </div>
          ...
          <div className="bg-[#9D00FF] text-white p-6 rounded-3xl flex items-center gap-6 shadow-lg shadow-purple-200">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2 tracking-tight">ACTIVACIÓN EXPRESS</h3>
              <p className="text-purple-100">Implementación rápida, coordinada y precisa para salir al mercado e impactar inmediatamente.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#111111] rounded-3xl p-8 text-white relative overflow-hidden flex flex-col justify-between">
           ...
           <div>
             ...
             <h3 className="text-3xl font-extrabold mb-6 tracking-tight">VELOCIDAD DE EJECUCIÓN</h3>
             
             <ul className="space-y-4 mb-8">
               {['Concepto y Mensaje', 'Diseño Integral', 'Piezas de Campaña', 'Configuración de Ads'].map((item, i) => (
           ...
           <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center relative z-10">
              <p className="text-sm text-gray-400 mb-2">Una vez aprobado el plan:</p>
              <p className="text-xl font-bold leading-tight">La campaña puede estar instalada en menos de <span className="text-[#9D00FF]">3 días</span>.</p>
           </div>
        </div>
